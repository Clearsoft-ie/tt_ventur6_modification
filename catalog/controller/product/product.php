...
/*XML*/
			...
			$data['module_productaccessories_status'] = $this->config->get('module_productaccessories_status');
			$data['module_productaccessories_namestatus'] = $this->config->get('module_productaccessories_namestatus');
			$data['module_productaccessories_model'] = $this->config->get('module_productaccessories_model');
			$data['module_productaccessories_price'] = $this->config->get('module_productaccessories_price');
			$data['module_productaccessories_qty'] = $this->config->get('module_productaccessories_qty');
			$data['module_productaccessories_imagestatus'] = $this->config->get('module_productaccessories_imagestatus');
			$data['module_productaccessories_layout'] = $this->config->get('module_productaccessories_layout');
			$data['module_productaccessories_img_type'] = $this->config->get('module_productaccessories_img_type');
			$data['module_productaccessories_headingtatus'] = $this->config->get('module_productaccessories_headingtatus');
			$data['module_productaccessories_accessory_setting'] = $this->config->get('module_productaccessories_accessory_setting');
			
			$data['entry_headingtitle'] = $this->config->get('module_productaccessories_heading' . $this->config->get('config_language_id'));
			$data['entry_imagetitle'] = $this->config->get('module_productaccessories_imagetitle' . $this->config->get('config_language_id'));
			$data['entry_productname'] = $this->config->get('module_productaccessories_productname' . $this->config->get('config_language_id'));
			$data['entry_modeltitle'] = $this->config->get('module_productaccessories_productmodel' . $this->config->get('config_language_id'));
			$data['entry_pricetext'] = $this->config->get('module_productaccessories_productprice' . $this->config->get('config_language_id'));
			$data['entry_quantity'] = $this->config->get('module_productaccessories_productquantity' . $this->config->get('config_language_id'));
			$data['entry_action'] = $this->config->get('module_productaccessories_action' . $this->config->get('config_language_id'));
			$data['entry_tabname'] = $this->config->get('module_productaccessories_tabname' . $this->config->get('config_language_id'));
			
			$data['accessoriesproducts'] = array();
			$this->model_catalog_product->Table();
			$accessoriesresults = $this->model_catalog_product->getProductaccessories($this->request->get['product_id']);
			
			$width = ($this->config->has('module_productaccessories_width') ? $this->config->get('module_productaccessories_width') : 50);
			$height = ($this->config->has('module_productaccessories_height') ? $this->config->get('module_productaccessories_height') : 50);
			foreach($accessoriesresults as $result){
				if ($result['image']){
